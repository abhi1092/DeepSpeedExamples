...
class CftModel(nn.Module):
    ...
    def gradient_checkpointing_enable(self):
        self.cfttranrsformer.gradient_checkpointing_enable()
    ...
    def forward(self,
                ...
                use_cache=False,
                labels=None,
                use_negative_data=None):
        loss = None

        output = self.cfttranrsformer(
            input_ids,
        ...
        assert use_negative_data is not None
        ...
        print(use_negative_data_rejected.shape)
        print(chosen_labels.shape)
        print(chosen_lm_logits.shape)
        exit()
    ...
    #                   use_cache=False):
    #
    #     transformer_outputs = self.cfttranrsformer(
    #         input_ids,
    #         past_key_values=past_key_values,
    #         attention_mask=attention_mask,
    #         head_mask=head_mask,
